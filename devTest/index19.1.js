// урок 22 объекты. добавим днйствия с созданными объектами
// car.engin.v = 2;
window.alert(car.some);
// объект меняет свое состояние с помощию своего же метода start
car.start();
window.alert(car.some);
window.alert(car.spid);
